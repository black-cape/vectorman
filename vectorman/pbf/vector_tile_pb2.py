...
_TILE_GEOMTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="LINESTRING", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="POLYGON", index=3, number=3, serialized_options=None, type=None
        ),
    ],
...
_TILE_VALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="string_value",
            full_name="vector_tile.Tile.Value.string_value",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="float_value",
            full_name="vector_tile.Tile.Value.float_value",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="double_value",
            full_name="vector_tile.Tile.Value.double_value",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="int_value",
            full_name="vector_tile.Tile.Value.int_value",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="uint_value",
            full_name="vector_tile.Tile.Value.uint_value",
            index=4,
            number=5,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="sint_value",
            full_name="vector_tile.Tile.Value.sint_value",
            index=5,
            number=6,
            type=18,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="bool_value",
            full_name="vector_tile.Tile.Value.bool_value",
            index=6,
            number=7,
            type=8,
            cpp_type=7,
...
_TILE_FEATURE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="vector_tile.Tile.Feature.id",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="tags",
            full_name="vector_tile.Tile.Feature.tags",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="vector_tile.Tile.Feature.type",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="geometry",
            full_name="vector_tile.Tile.Feature.geometry",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
...
_TILE_LAYER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="version",
            full_name="vector_tile.Tile.Layer.version",
            index=0,
            number=15,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="vector_tile.Tile.Layer.name",
            index=1,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="features",
            full_name="vector_tile.Tile.Layer.features",
            index=2,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="keys",
            full_name="vector_tile.Tile.Layer.keys",
            index=3,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="values",
            full_name="vector_tile.Tile.Layer.values",
            index=4,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="extent",
            full_name="vector_tile.Tile.Layer.extent",
            index=5,
            number=5,
            type=13,
            cpp_type=3,
...
_TILE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="layers",
            full_name="vector_tile.Tile.layers",
            index=0,
            number=3,
            type=11,
            cpp_type=10,
